...
Como explicado em "Parâmetros padrão":/docs/developer-guide/models#model/parametros, @recursion@ pode ser sobrescrito com a passagem explícita do parâmetro pelo _array_ de opções de uma consulta:
