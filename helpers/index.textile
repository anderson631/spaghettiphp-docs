...
Dois _helpers_ vêm habilitados por padrão na instalação do Spaghetti*: um para  "HTML":/docs/developer-guide/html-helper e outro para "formulários":/docs/developer-guide/form-helper.
